                    ...
                    <div class="card border-0 shadow components-section">
                        <div class="card-body">
                            ...
                            <div id="sasaran-checkbox-list">
                                <?php $__currentLoopData = $sasaranGrouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sasaranId => $sasaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-3">
                                        <h6 class="mb-1">
                                            <input type="checkbox" class="form-check-input sasaran-checkbox"
                                                   name="selected_sasaran"
                                                   value="<?php echo e($sasaranId); ?>"
                                                   id="sasaran_<?php echo e($sasaranId); ?>">
                                            <label for="sasaran_<?php echo e($sasaranId); ?>" class="fw-bold">
                                                <?php echo e($sasaran['number']); ?>. <?php echo e($sasaran['perspektif']); ?>

                                            </label>
                                        </h6>

                                        <div class="iku-list mt-2" id="iku-list-<?php echo e($sasaranId); ?>" style="display: none;">
                                            <?php if(count($sasaran['ikus']) > 0): ?>
                                                <?php $__currentLoopData = $sasaran['ikus']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input iku-checkbox"
                                                               name="selected_iku"
                                                               value="<?php echo e($iku); ?>"
                                                               id="iku_<?php echo e($sasaranId); ?>_<?php echo e($loop->index); ?>">
                                                        <label class="form-check-label" for="iku_<?php echo e($sasaranId); ?>_<?php echo e($loop->index); ?>">
                                                            <?php echo e($iku); ?>
