...
<link rel="mask-icon" href="<?php echo e(asset('assets/img/favicon/safari-pinned-tab.svg')); ?>" color="#ffffff">
                            ...
                            <form method="POST" action="/register" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="id" class="form-control" placeholder="Enter your user ID" id="id" value="<?php echo e(old('id')); ?>" autofocus required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" placeholder="Your Name" id="nama" value="<?php echo e(old('nama')); ?>" required>
                                    </div>
                                </div>
...
<?php /**PATH C:\Users\ghifa\Documents\admin-dashboard\resources\views\authentication\sign-up.blade.php ENDPATH**/ ?>