...
<body>
    ...
    <main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                <div class="row justify-content-center form-bg-image" style="margin-top: 65px" data-background-lg="<?php echo e(asset('assets/img/illustrations/signin.svg')); ?>">
                            ...
                            <form method="POST" action="/" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="id" class="form-control" placeholder="1xx" id="id" required>
                                    </div>
                                </div>
...
<?php /**PATH C:\Users\ghifa\Documents\admin-dashboard\resources\views\authentication\sign-in.blade.php ENDPATH**/ ?>