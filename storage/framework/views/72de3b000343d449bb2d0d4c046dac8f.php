                        ...
                        <div class="row mb-4">
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="iku_atasan" id="iku_atasan" value="<?php echo e($iku->iku_atasan); ?>"required>
                                    <label for="target">Target</label>
                                    <input type="text" class="form-control" name="target" id="target" value="<?php echo e($iku->target); ?>"required>
                                </div>
                                <!-- End of Form -->
                                <div class="mb-3">
                                    <label for="iku">Indikator Kerja Utama</label>
                                    <input type="text" class="form-control" name="iku" id="iku" value="<?php echo e($iku->iku); ?>"required>
                                </div>
                                <div class="mb-3">
                                    <h5>Target</h5>
                                    ...
                                    <input type="text" class="form-control" name="stretch" id="stretch" value="<?php echo e($iku->stretch); ?>"required>
                                </div>
                                <div class="mb-3">
