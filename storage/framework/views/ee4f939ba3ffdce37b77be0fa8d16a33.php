                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="../../assets/img/illustrations/signin.svg">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form method="POST" action="<?php echo e(url('/users/update/'.$user->id)); ?>" class="mt-4">
                                <?php echo csrf_field(); ?>
                                <!-- Form -->
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="id" class="form-control" placeholder="Enter your user ID" id="id" value="<?php echo e($user->id); ?>" autofocus >
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" placeholder="Your Name" id="nama" value="<?php echo e($user->nama); ?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="full_name" class="form-control" placeholder="Your Name" id="nama" value="<?php echo e($user->full_name); ?>" >
                                    </div>
                                </div>
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800">Edit User <?php echo $name ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
